...
public class LetterJ extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterJ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterJ = (ImageButton) findViewById(R.id.ibt_letter_j);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterJ.setOnClickListener(this);
