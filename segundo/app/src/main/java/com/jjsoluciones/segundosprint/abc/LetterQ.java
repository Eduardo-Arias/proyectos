...
public class LetterQ extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterQ = (ImageButton)findViewById(R.id.ibt_letter_q);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterQ.setOnClickListener(this);
