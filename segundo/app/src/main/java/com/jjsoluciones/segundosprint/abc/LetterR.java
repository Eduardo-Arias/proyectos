...
public class LetterR extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterR = (ImageButton)findViewById(R.id.ibt_letter_r);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterR.setOnClickListener(this);
