...
public class LetterG extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterG = (ImageButton) findViewById(R.id.ibt_letter_g);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterG.setOnClickListener(this);
