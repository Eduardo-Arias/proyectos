...
public class LetterB extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterB = (ImageButton) findViewById(R.id.ibt_letter_b);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterB.setOnClickListener(this);
