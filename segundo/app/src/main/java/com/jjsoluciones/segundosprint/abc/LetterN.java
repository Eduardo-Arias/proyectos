...
public class LetterN extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterN = (ImageButton) findViewById(R.id.ibt_letter_n);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterN.setOnClickListener(this);
