...
public class LetterC extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterC = (ImageButton) findViewById(R.id.ibt_letter_c);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterC.setOnClickListener(this);
