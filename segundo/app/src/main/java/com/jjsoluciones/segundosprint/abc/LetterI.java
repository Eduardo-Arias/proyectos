...
public class LetterI extends AppCompatActivity implements View.OnClickListener{

private ImageButton ibtLetterI;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterI = (ImageButton) findViewById(R.id.ibt_letter_i);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterI.setOnClickListener(this);
