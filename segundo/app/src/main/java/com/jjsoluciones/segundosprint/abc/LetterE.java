...
public class LetterE extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterE = (ImageButton) findViewById(R.id.ibt_letter_e);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterE.setOnClickListener(this);
