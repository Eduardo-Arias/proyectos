...
public class LetterK extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterK = (ImageButton) findViewById(R.id.ibt_letter_k);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterK.setOnClickListener(this);
