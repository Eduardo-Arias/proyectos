...
public class LetterM extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterM = (ImageButton) findViewById(R.id.ibt_letter_m);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterM.setOnClickListener(this);
