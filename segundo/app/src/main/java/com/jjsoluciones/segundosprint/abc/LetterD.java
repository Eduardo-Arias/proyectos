...
public class LetterD extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterD;
    private ImageView ibtInicio;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_letter_d);
        ibtLetterD = (ImageButton) findViewById(R.id.ibt_letter_d);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterD.setOnClickListener(this);
