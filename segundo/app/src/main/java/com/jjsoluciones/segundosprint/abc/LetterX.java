...
public class LetterX extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterX;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterX = (ImageButton)findViewById(R.id.ibt_letter_x);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterX.setOnClickListener(this);
