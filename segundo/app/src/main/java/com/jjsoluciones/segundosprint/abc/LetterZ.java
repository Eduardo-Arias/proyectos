...
public class LetterZ extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterZ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterZ = (ImageButton)findViewById(R.id.ibt_letter_z);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterZ.setOnClickListener(this);
