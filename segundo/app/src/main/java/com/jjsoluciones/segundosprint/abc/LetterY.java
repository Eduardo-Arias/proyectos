...
public class LetterY extends AppCompatActivity implements View.OnClickListener{

    private ImageButton ibtLetterY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtLetterY = (ImageButton)findViewById(R.id.ibt_letter_y);
        ibtInicio = (ImageView) findViewById(R.id.ibt_inicio);

        ibtLetterY.setOnClickListener(this);
